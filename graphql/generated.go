...
func (ec *executionContext) _Mutation_createUser(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	if tmp, ok := field.Args["input"]; ok {
		var err error
		arg0, err = UnmarshalCreateUserInput(tmp)
		if err != nil {
			ec.Error(ctx, err)
			return graphql.Null
		}
...
func (ec *executionContext) _Mutation_createPost(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	if tmp, ok := field.Args["input"]; ok {
		var err error
		arg0, err = UnmarshalCreatePostInput(tmp)
		if err != nil {
			ec.Error(ctx, err)
			return graphql.Null
		}
...
func (ec *executionContext) _Post_createdAt(ctx context.Context, field graphql.CollectedField, obj *Post) graphql.Marshaler {
	rctx := graphql.GetResolverContext(ctx)
	rctx.Object = "Post"
	rctx.Args = nil
	rctx.Field = field
...
func UnmarshalCreatePostInput(v interface{}) (CreatePostInput, error) {
